# Author: Habib Sabiu
# Date: March 31, 2017
# Purpose: Script to process Spark log files generated when running Spark applications on Standalone
...
fig, ax = plt.subplots()
plt.title("Standalone - DRA with 10 maximum executors", fontsize=15)
plt.ylabel("Number of executors allocated", fontsize=15)
plt.xlabel("Timestamp", fontsize=15)
plt.xlim([datetime(2017, 02, 16, 10, 31, 00), datetime(2017, 02, 16, 10, 41, 30)])
#plt.ylim([-5, 100])
plt.ylim([-0.3, 12])
