# Author: Habib Sabiu
# Date: March 31, 2017
# Purpose: Script to process Spark log files generated when running Spark applications on YARN
...
fig, ax = plt.subplots()
plt.title("YARN - DRA with 10 maximum executors", fontsize=15)
plt.ylabel("Number of executors allocated", fontsize=15)
plt.xlabel("Timestamp", fontsize=15)
plt.xlim([datetime(2017, 02, 16, 10, 54, 40), datetime(2017, 02, 16, 11, 8, 30)])
plt.ylim([-0.3, 12])
#plt.ylim([-3, 60])
