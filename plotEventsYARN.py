...
#          YARN cluster manager. This script would loop through all the log files in the
...
fig, ax = plt.subplots()
plt.title("YARN - Dynamic default with 8 cores, 11GB per executors", fontsize=15)
plt.ylabel("Number of executors allocated", fontsize=15)
plt.xlabel("Elapsed Time (s)", fontsize=15)

plt.xlim([-6, maxTimestamp + 100])
plt.ylim([0, maxExecutors + 3])
